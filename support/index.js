            ...
            if (chatId === 173191632) {
                arr.forEach(({ user, hashrate, coin }) => {
                    ...
                    switch (user) {
                        case "mom":
                            userName = "Мама - ";
                            if (hashrate !== false && (coin === "eth" && hashrate < 40 || coin === "btg" && hashrate < 300)) {
                                resText += "******************************************\n";
                            }
                            break
                        case "sanya":
                            if (coin === "eth" && hashrate < 380) {
                                resText += "******************************************\n";
                                bot.sendMessage(
                                    478916730,
                            ...
                            break
                        case "me":
                            if (coin === "eth" && hashrate < 650 || coin === "zen" && hashrate < 30 || coin === "zcl" && hashrate < 250) {
                                resText += "******************************************\n";
                            }
                            userName = "Я - ";
                            break
